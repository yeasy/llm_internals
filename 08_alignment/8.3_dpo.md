...
- **推理 RL 算法**：GRPO（Group Relative Policy Optimization）使用组内标准化优势替代单独的价值网络，公式见 [14.6 节](../14_future_trends/14.6_test_time_scaling.md)；DAPO 和 GSPO 等后续方法进一步改进采样、裁剪和序列级稳定性，服务于长思维链与 MoE 等大规模后训练。
