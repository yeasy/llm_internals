...
* [第三章：Transformer 核心组件解析](03_components/README.md)
  * [3.1 分词：从文本到词元](03_components/3.1_tokenization.md)
  * [3.2 词嵌入：从离散符号到连续向量](03_components/3.2_embedding.md)
  * [3.3 位置编码：为什么顺序信息必须显式注入](03_components/3.3_position_encoding.md)
  * [3.4 前馈网络：Transformer 的“记忆层”](03_components/3.4_feedforward.md)
...
* [第七章：大规模分布式训练](07_distributed_training/README.md)
  ...
  * [7.5 激活重计算：用时间换空间的艺术](07_distributed_training/7.5_activation_checkpointing.md)
  * [7.6 混合精度训练：精度与速度的权衡](07_distributed_training/7.6_mixed_precision.md)
  * [7.7 检查点管理与容错](07_distributed_training/7.7_checkpoint.md)
...
* [第十一章：推理引擎与生产部署](11_serving/README.md)
  ...
  * [11.3 调度循环与抢占：一个请求在引擎里的全过程](11_serving/11.3_scheduler_loop.md)
  * [11.4 KV 显存管理：块表、换出与重算](11_serving/11.4_kv_memory_management.md)
  * [11.5 前缀复用：哈希块与前缀树](11_serving/11.5_prefix_reuse.md)
  * [11.6 多 LoRA 服务：一份基础权重，许多适配器](11_serving/11.6_multi_lora_serving.md)
  * [11.7 约束解码：让输出必然合乎语法](11_serving/11.7_constrained_decoding.md)
  * [11.8 多卡推理：张量并行、流水线并行与专家并行](11_serving/11.8_multi_gpu_inference.md)
  * [11.9 分离式 Prefill-Decode 架构](11_serving/11.9_disaggregated_serving.md)
  * [11.10 实例剖析：vLLM](11_serving/11.10_vllm_internals.md)
...
* [第十四章：架构创新与未来趋势](14_future_trends/README.md)
  * [14.1 高效注意力：突破平方复杂度的瓶颈](14_future_trends/14.1_efficient_attention.md)
