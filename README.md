# Transformer 与大语言模型：原理、训练与推理

> 深入理解 Transformer 为什么能工作、为什么这样设计，系统掌握从架构原理到训练部署的完整知识体系。
...
- **算法工程师**：从事大模型训练、微调与部署的工程师
- **机器学习从业者**：希望从 "会用" 进阶到 "理解为什么" 的开发者
- **高校师生**：深度学习与自然语言处理方向的教学参考
...
- **第四部分（前沿与实践篇）**：从经典模型的设计思路到前沿架构的创新逻辑
...
- 重要术语首次出现时会给出中英文对照及简要解释
- 数学公式使用 LaTeX 格式，并附直觉解释
- 代码示例主要基于 PyTorch 框架
- 图示优先使用 Mermaid 语法，辅以生成图片
