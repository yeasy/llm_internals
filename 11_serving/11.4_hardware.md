...
**TPU**（Tensor Processing Unit）是 Google 专门为深度学习设计的加速器。上一代 **TPU v6e（Trillium）** 相比 v5e 在每芯片计算性能上提升了 4.7 倍，HBM 容量和带宽均大幅增加，并支持 FP8 等低精度格式。Google Cloud 当前文档将 **TPU7x（Ironwood）** 标为最新 TPU，面向大规模 AI 训练和推理。
