...
本章解决了从原始文本到层内计算，每个零件“为什么非有不可”的问题，并把它们接成了完整的编码器-解码器架构。但它留下一个没回答的问题——[3.3 节](3.3_position_encoding.md)在位置编码上只摆出了正弦公式，并断言“任意两个位置之间的相对距离可以通过线性变换表示”，却既没有解释为什么偏偏是正弦，也没有证明那条线性性质。这正是下一章的起点。
