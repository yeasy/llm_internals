...
91. Sebastian Raschka. [LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)（*Build a Large Language Model (From Scratch)*, Manning, 2024 的官方配套代码，Apache-2.0）。本书讲原理，该仓库提供可逐步运行的 PyTorch 实现，二者互补；其 `ch04` 下的 GQA、MLA、SWA、跨层 KV 共享等对照实现，可与[第 10.2 节](../10_inference_optimization/10.2_kv_cache.md)的四条压缩轴对读。
