...
> 核验日期：2026-06-09。高漂移模型条目（如 GPT、Claude、Gemini、Llama 的上下文窗口、价格和发布时间）应以官方模型页、价格页和发布说明为准；本表只作为阅读时的技术快照。
...
| Claude Fable 5 | 2026.06.09 | Decoder | 未公开 | - | - | - | 1M | 新一代命名体系；能力最强的广泛发布模型，128K 输出、Adaptive Thinking 常开（\$10/\$50）；同日 Mythos 5 仅限受邀 |
...
| GPT-5.5 | 2026.04.23 | Decoder | 未公开 | - | - | - | 1,050,000 | 官方旗舰（\$5/\$30） |
